...
function initToggleSections() {
  ...
  if (storylineText) {
    ...
    storylineText.parentNode.insertBefore(
      readMoreBtn,
      storylineText.nextSibling
    );
  ...
  if (reviewText.length > 1) {
    ...
    secondParagraph.parentNode.insertBefore(
      toggleReview,
...
function initReviewCard() {
  ...
  if (helpfulBtn) {
    helpfulBtn.addEventListener("click", () => {
      ...
      if (
        helpfulBtn.classList.contains("helpful-active") &&
        notHelpfulBtn &&
        notHelpfulBtn.classList.contains("not-helpful-active")
      ) {
